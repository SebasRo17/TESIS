    ...
    <div className="min-h-[calc(100vh-64px)] bg-gradient-to-b from-cyan-50 via-white to-indigo-50">
      <div className="mx-auto w-full max-w-6xl px-4 py-10">
        ...
        <div className="mb-7 flex flex-col gap-2">
          <div className="inline-flex w-fit items-center gap-2 rounded-full border border-cyan-200 bg-white/70 px-4 py-2 shadow-sm">
...
const cardClass =
  "rounded-3xl border border-slate-200/70 bg-white/90 p-6 shadow-[0_18px_50px_rgba(2,6,23,0.08)]";
